...
$(function(){
	...
	$('#world-map').vectorMap({
            ...
            markers :[
                {latLng: [15.3413887,81.51989,5.5], name: 'Sample Name 1'},
                {latLng: [34.3145243,30.7392949,4.25], name: 'Sample Name 2'},
                {latLng: [33.3139287,-152.4080805,4.5], name: 'Sample Name 3'},
                {latLng: [15.3740683,-20.0902695,4], name: 'Sample Name 4'},
                {latLng: [37.851581,143.9289516,6.25], name: 'Sample Name 4'},
                {latLng: [38.4803212,13.8681777,5.75], name: 'Liechtenstein'},
                {latLng: [-14.9947985,157.6090279], name: 'Sample Name 4'},
                {latLng: [8.2885385, -79.5197105], name: 'Sample Name 4'},
                {latLng: [-1.4781412,57, -63.1239322,3.75], name: 'Liechtenstein'},
            ],
        });
    }
});
